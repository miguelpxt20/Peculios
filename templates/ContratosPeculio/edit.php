 ...
 * @var string[]|\Cake\Collection\CollectionInterface $associados
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $contratosPeculioEntity->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $contratosPeculioEntity->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="contratosPeculio form content">
            ...
            <fieldset>
                <legend><?= __('Edit Contratos Peculio') ?></legend>
                <?php
